...
class JpegUtils
{
    ...
    */
    ...
    /// </summary>
    public static void jcopy_sample_rows(in ComponentBuffer input_array, int source_row, byte[][] output_array, int dest_row, int num_rows, int num_cols)
    {
        for (int row = 0; row < num_rows; row++)
        {
            input_array[source_row + row].Slice(0, num_cols).CopyTo(output_array[dest_row + row]);
        }
    }

    public static void jcopy_sample_rows(in ComponentBuffer input_array, int source_row, in ComponentBuffer output_array, int dest_row, int num_rows, int num_cols)
    {
        for (int row = 0; row < num_rows; row++)
        {
            input_array[source_row + row].Slice(0, num_cols).CopyTo(output_array[dest_row + row]);
