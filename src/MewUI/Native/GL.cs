...
internal static class GL
{
    ...
    public static void Ortho(double left, double right, double bottom, double top, double zNear, double zFar)
    {
        ...
        {
            LibGL.glOrtho(left, right, bottom, top, zNear, zFar);
        }
    }
    ...
    public static void Scissor(int x, int y, int width, int height)
    {
        if (OperatingSystem.IsWindows())
        {
            OpenGL32.glScissor(x, y, width, height);
        }
        else
        {
            LibGL.glScissor(x, y, width, height);
        }
    }
    ...
    public static void BlendFunc(uint sfactor, uint dfactor)
    {
        ...
        {
            LibGL.glBlendFunc(sfactor, dfactor);
        }
    }
    ...
    public static void Hint(uint target, uint mode)
    {
        if (OperatingSystem.IsWindows())
        {
            OpenGL32.glHint(target, mode);
        }
        else
        {
            LibGL.glHint(target, mode);
        }
    }
    ...
    public static void ClearColor(float red, float green, float blue, float alpha)
    {
        ...
        {
            LibGL.glClearColor(red, green, blue, alpha);
        }
    }
    ...
    public static void Color4ub(byte red, byte green, byte blue, byte alpha)
    {
        ...
        {
            LibGL.glColor4ub(red, green, blue, alpha);
        }
    }
